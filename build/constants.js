...
var getCookiePolicyPageUrl = function getCookiePolicyPageUrl(LMS_BASE_URL) {
  return "".concat(LMS_BASE_URL, "/cookies");
};
...
var IETF_TAGS_TO_CONTAINER_ROLE_LABEL = function IETF_TAGS_TO_CONTAINER_ROLE_LABEL(SITE_NAME) {
  return Object.freeze(_defineProperty(_defineProperty({}, ENGLISH_IETF_TAG, "Notice about use of cookies on ".concat(SITE_NAME, ".")), SPANISH_IETF_TAG, "Aviso sobre el uso de cookies en ".concat(SITE_NAME, ".")));
};
var IETF_TAGS_TO_CLOSE_BUTTON_LABEL = function IETF_TAGS_TO_CLOSE_BUTTON_LABEL(SITE_NAME) {
  return Object.freeze(_defineProperty(_defineProperty({}, ENGLISH_IETF_TAG, "Close the notice about use of cookies on ".concat(SITE_NAME, ".")), SPANISH_IETF_TAG, "Cerrar aviso sobre el uso de cookies en ".concat(SITE_NAME, ".")));
};
var getBannerLinkOpen = function getBannerLinkOpen(LMS_BASE_URL) {
  return "<a href=\"".concat(getCookiePolicyPageUrl(LMS_BASE_URL), "\" class=\"policy-link\" target=\"_blank\">");
};
var bannerLinkClose = '</a>';
var getIetfTagToBannerText = function getIetfTagToBannerText(LMS_BASE_URL) {
  return Object.freeze(_defineProperty(_defineProperty(_defineProperty({}, ENGLISH_IETF_TAG, "We use cookies on this site to enhance your user experience. By using this website, you accept this use. Learn more about it in ".concat(getBannerLinkOpen(LMS_BASE_URL), "Cookie Policy").concat(bannerLinkClose, ". For a complete overview of all cookies used, please see your personal settings.\n  ")), SPANISH_IETF_TAG, "Utilizamos cookies en este sitio para mejorar su experiencia de usuario. Al utilizar este sitio web, usted acepta este uso. Obtenga m\xE1s informaci\xF3n al respecto en ".concat(getBannerLinkOpen(LMS_BASE_URL), "Pol\xEDtica de cookies").concat(bannerLinkClose, ". Para obtener una descripci\xF3n completa de todas las cookies utilizadas, consulte su configuraci\xF3n personal.")), UKRAINIAN_IETF_TAG, "\u041C\u0438 \u0432\u0438\u043A\u043E\u0440\u0438\u0441\u0442\u043E\u0432\u0443\u0454\u043C\u043E \u0444\u0430\u0439\u043B\u0438 cookie \u043D\u0430 \u0446\u044C\u043E\u043C\u0443 \u0441\u0430\u0439\u0442\u0456, \u0449\u043E\u0431 \u043F\u043E\u043A\u0440\u0430\u0449\u0438\u0442\u0438 \u0432\u0430\u0448 \u0434\u043E\u0441\u0432\u0456\u0434 \u043A\u043E\u0440\u0438\u0441\u0442\u0443\u0432\u0430\u0447\u0430. \u0412\u0438\u043A\u043E\u0440\u0438\u0441\u0442\u043E\u0432\u0443\u044E\u0447\u0438 \u0446\u0435\u0439 \u0432\u0435\u0431\u0441\u0430\u0439\u0442, \u0432\u0438 \u043F\u043E\u0433\u043E\u0434\u0436\u0443\u0454\u0442\u0435\u0441\u044C \u0437 \u0457\u0445\u043D\u0456\u043C \u0432\u0438\u043A\u043E\u0440\u0438\u0441\u0442\u0430\u043D\u043D\u044F\u043C. \u0414\u043E\u043A\u043B\u0430\u0434\u043D\u0456\u0448\u0435 \u0447\u0438\u0442\u0430\u0439\u0442\u0435 \u0432 ".concat(getBannerLinkOpen(LMS_BASE_URL), "\u041F\u043E\u043B\u0456\u0442\u0438\u0446\u0456 \u0432\u0438\u043A\u043E\u0440\u0438\u0441\u0442\u0430\u043D\u043D\u044F \u0444\u0430\u0439\u043B\u0456\u0432 cookie").concat(bannerLinkClose, ". \u0414\u043B\u044F \u043F\u0435\u0440\u0435\u0433\u043B\u044F\u0434\u0443 \u0432\u0441\u0456\u0445 \u0444\u0430\u0439\u043B\u0456\u0432 cookie, \u0449\u043E \u0432\u0438\u043A\u043E\u0440\u0438\u0441\u0442\u043E\u0432\u0443\u044E\u0442\u044C\u0441\u044F, \u0431\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430, \u043F\u0435\u0440\u0435\u0433\u043B\u044F\u043D\u044C\u0442\u0435 \u0441\u0432\u043E\u0457 \u043E\u0441\u043E\u0431\u0438\u0441\u0442\u0456 \u043D\u0430\u043B\u0430\u0448\u0442\u0443\u0432\u0430\u043D\u043D\u044F.")));
};
...
export { ENGLISH_IETF_TAG, SPANISH_IETF_TAG, UKRAINIAN_IETF_TAG, DEFAULT_IETF_TAG, ENGLISH_LANGUAGE_CODE, IETF_TAGS, IETF_TAGS_TO_CONTAINER_ROLE_LABEL, IETF_TAGS_TO_CLOSE_BUTTON_LABEL, getIetfTagToBannerText, IETF_TAGS_TO_LANGUAGE_CODE, LANGUAGE_CODE_TO_IETF_TAGS, LOCALHOST, getPolicyHTML };