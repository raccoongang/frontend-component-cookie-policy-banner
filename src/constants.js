...
const IETF_TAGS_TO_BANNER_TEXT = Object.freeze({
  ...
  `,
  [FRENCH_CA_IETF_TAG]: `Nous utilisons des témoins sur ce site pour améliorer votre expérience. En utilisant ce site, vous acceptez cette utilisation. En savoir plus dans la ${bannerLinkOpen}Politique relative aux témoins${bannerLinkClose}. Pour un aperçu complet de tous les témoins utilisés, veuillez consulter vos paramètres personnels.
  `,
